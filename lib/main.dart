...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Products in a specific restaurant 
      // '/products': (context) => const RestaurantProductsScreen(),
      
      // Search functionality
      // '/search': (context) => const SearchProductScreen(),
      
      // Search results (List and Map views)
